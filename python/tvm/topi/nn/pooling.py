...
def pool(
    data, kernel, stride, padding, pool_type, ceil_mode=False, layout="NCHW", count_include_pad=True, return_indices=False,
):
...
def pool1d(
    data, kernel, stride, padding, pool_type, ceil_mode=False, layout="NCW", count_include_pad=True, return_indices=False,
):
